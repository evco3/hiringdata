...
export function PointsPerChart({ player }: PointsPerChartProps) {
    ...
    useEffect(() => {
        ...
        const exampleData = [
            { season: 2021, points: 50 },
            { season: 2022, points: 60 },
            { season: 2023, points: 70 },
            { season: 2024, points: 80 },
            { season: 2025, points: 90 },
        ];
